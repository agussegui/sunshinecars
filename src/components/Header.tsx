      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="hidden lg:flex space-x-8 xl:space-x-12">
              {[
                ...
                <button
                  ...
                  className="text-gray-300 hover:text-orange-400 hover:scale-105 transition-all duration-500 ease-in-out text-lg font-medium tracking-wide font-raleway transform hover:-translate-y-0.5"
                >
                  {item.name}
                </button>
              ))}
            ...
            <Button
              size="sm"
              className="hidden lg:block bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 xl:px-6 xl:py-2 rounded-full font-medium transition-all duration-300 font-raleway text-md"
            >
              Pedir Turno
            </Button>
            <button
        ...
        <div className="pt-24 px-6">
          <nav className="space-y-4">
            {[
              { name: "NOSOTROS", id: "nosotros" },
              { name: "SERVICIOS", id: "servicios" },
              { name: "PREGUNTAS FRECUENTES", id: "preguntas" },
              { name: "GALERÍA", id: "galeria" },
              { name: "CONTACTO", id: "contacto" },
            ].map((item) => (
              <button
