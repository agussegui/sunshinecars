...
const HeroSection = () => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 md:mt-0 mt-14">
        <div className="text-center">
          ...
          <p className="text-gray-300 md:text-lg mb-8 max-w-2xl mx-auto leading-relaxed font-raleway">
            Hacemos que tu auto (o tu flota) quede prolijo sin complicaciones. Elegí un plan y te contamos en claro qué
            hacemos, cuánto tarda y cómo queda.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <div className="bg-gray-900/70 px-4 py-2 rounded-full text-sm font-raleway">A domicilio</div>
            <div className="bg-gray-900/70 px-4 py-2 rounded-full text-sm font-raleway">Sin letra chica</div>
            <div className="bg-gray-900/70 px-4 py-2 rounded-full text-sm font-raleway">Duración estimada</div>
          </div>
      ...
      <div className="absolute top-1/4 right-10 w-2 h-2 bg-orange-400 rounded-full opacity-60 animate-pulse"></div>
      <div className="absolute bottom-1/3 left-10 w-3 h-3 bg-orange-400 rounded-full opacity-40 animate-pulse delay-1000"></div>
      <div className="absolute top-1/2 right-1/4 w-1 h-1 bg-orange-300 rounded-full opacity-80 animate-ping"></div>
    </section>
  )
}
