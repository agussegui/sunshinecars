    ...
    <section className="">
      <div className="w-full py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-white text-3xl md:text-4xl font-bold font-contrail-one mb-4">¿Listo para coordinar?</h2>
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                "https://wa.me/5492211234567?text=Hola! Quiero coordinar un turno para el lavado de mi auto",
                "_blank",
              )
            }
